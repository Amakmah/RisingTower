...
const server = HTTP.createServer((req, res) => {
	...
	if (req.url == '/' || req.url == '/index.html') {
		...
		res.end(cssFile);
	} else if (req.url == '/styles/style_page_404.css' || req.url == '/public/styles/style_page_404.css') {
		res.writeHead(200, {
			'Content-Type': 'text/css'
		});
		...
		res.end(cssFile);
	} else if (req.url == '/scripts/scripts.js' || req.url == '/public/scripts/scripts.js') {
		res.writeHead(200, {
